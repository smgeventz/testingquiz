...
function ProtectedRoute({ children }) {
  ...
  const subAdminMenu = [
    {
      title: "Home",
      paths: ["/", "/subadmin/manage-exams"],
      icon: <i className="ri-home-line"></i>,
      onClick: () => navigate("/"),
    },
    {
      title: "ManageTests",
      paths: ["/subadmin/ManageTestPage"],
      icon: <i className="ri-bar-chart-line"></i>,
      onClick: () => navigate("/subadmin/ManageTestPage"),
    },
    {
      title: "report",
      paths: ["/subadmin/report"],
      icon: <i className="ri-file-list-line"></i>,
      onClick: () => navigate("/subadmin/report"),
    },
    {
      title: "Logout",
      paths: ["/logout"],
    ...
    try {
      ...
      if (response.success) {
        ...
        if (response.data.isAdmin) {
          setMenu(adminMenu);
        } else if (response.data.isSubAdmin) {
          setMenu(subAdminMenu);
        } else {
          setMenu(userMenu);
        }
      } else {
      ...
      <div className="flex gap-2 w-full h-full h-100">
        ...
        <div className="body">
          <div className="header flex justify-between">
            ...
            <h1 className="text-2xl text-white">Test Application</h1>
            <div>
